    ...
    <div class="container">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            ...
            <form action="{{ route('search.search') }}" method="GET"
                ...
                <table>
                    <tr>
                        <td><input type="search" class="form-control form-control-dark" name="search" placeholder="Search..." aria-label="Search" required></td>
                        <td><button class="btn btn-outline-light me-2" type="submit">Search</button></td>
                    </tr>
                </table>
